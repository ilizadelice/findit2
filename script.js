...
function showEvents(choice) {
    ...
    const backgrounds = {
        ...
        "Conservation and Nature": "url('https://bpac.in/wp-content/uploads/2021/08/BlogsArtboard-1-copy-9.jpg')",
        "Religious Events": "url('https://www.shutterstock.com/image-photo/prophets-all-religions-bring-peace-600nw-2418758611.jpg')"
    };
    ...
    if (choice === "Arts and Culture") {
        ...
        output += eventHTML("Between Silence and Becoming – Solo Art Exhibition", "Ongoing / Dates vary", "KG 368 Street, Kigali", "free","English:A compelling visual arts experience featuring contemporary works in the heart of the city.","Mu kinyarwanda:Ubunararibonye butangaje bw'ubuhanzi bw'amashusho burimo ibihangano bigezweho biri mu mutima w'umujyi.","https://www.eventbrite.com/d/rwanda/rwanda/","https://www.newtimes.co.rw/events?_evDiscoveryPath=/event/3640365-between-silence-and-becoming-a-solo-art-exhibition-by-ford-j-bosco");
        ...
        output += eventHTML("Kigali Tote Bag Workshop","Daily / Flexible scheduling"," Golden Coffee Roastery, Kicukiro, Kigali","$19 USD (~25,000 RWF)","English Description: A beginner-friendly creative session guided by a local female artist where you design, paint, and customize your own tote bag to take home.","Kinyarwanda Description: Gahunda y'ububoshyi n'ubushushanyi iyoborwa n'umuhanzi w'umwamikazi w'i Kigali, aho wiga gushushanya ku bikapu by'igitambaro ukanabyitahana.","https://www.tripadvisor.com/AttractionProductReview-g293829-d34352626-Kigali_Paint_Your_Own_Tote_Bag_Workshop_with_Local_Artist-Kigali_Kigali_Province.html","https://www.getyourguide.com/kigali-l32466/kigali-paint-your-own-tote-bag-workshop-with-local-artist-t1299955/");
    }
        ...
        output += eventHTML("Kubumba Delight Pottery Experience","Weekly / By appointment","Nyarugenge District, Kigali City"," 43,000 RWF per person","English Description: A hands-on traditional pottery masterclass with local artisans to craft your own authentic Rwandan clay souvenir.","Kinyarwanda Description: Isomo ryo kubumba rya gakondo ritaraboneka ahandi, aho ufatanya n'abanyabugeni b'inzobere gukora umubumbe w'ibumbano bya Kinyarwanda.","https://www.nuttintodo.com/","https://theabroadguide.com/kigali-traditional-kubumba-pottery-making-with-local-women/");
        ...
        output += eventHTML("20 Years of King James Concert","Saturday, August 1, 2026, at 7:00 PM","BK Arena, KG 17 Avenue, Kigali"," Starting from 10,000 RWF (Regular) to 50,000 RWF (VIP)","English Description: A massive anniversary arena concert celebrating the iconic 20-year musical career and romantic hits of King James Ruhumuriza.","Kinyarwanda Description: Igitaramo gikomeye cyo kwizihiza imyaka 20 mu muziki y'umuhanzi King James Ruhumuriza mu ndirimbo ze z'urukundo zakunzwe na banyarwanda bose.","","");
        ...
        output += eventHTML("Mount Kigali Tactical Paintball Adventure",""," $35 USD (~46,000 RWF)","English Description: High-energy, tactical paintball battles set within the natural mountain terrains, perfect for team building and sports groups.","Kinyarwanda Description: Umukino urimo ingufu n'ubwenge bwo kurasana dukoresheje amabangi y'amabara, ubereye amatsinda cyangwa n'abantu ku giti cyabo ku musozi wa Kigali.","","");
        ...
        output += eventHTML("Saturday Business Networking Event","Saturday, June 13, 2026, at 11:00 AM","Norrsken House Kigali, Nyarugenge, Kigali City"," Free entry (Registration required)","English Description: A dynamic corporate and entrepreneurial mixer built to connect startup founders, local business leaders, and investors.","Kinyarwanda Description: Gahunda yo guhura n'urubyiruko ndetse n'abashoramari, abashaka guhanga udushya mu bucuruzi hagamijwe kwagura imikoranire no kumenyana.","https://www.eventbrite.com/d/rwanda/events/","https://www.norrsken.org/events");
