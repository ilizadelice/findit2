function showEvents(choice) {
    ...
    if (choice === "Arts and Culture") {
        ...
        <a href="https://www.newtimes.co.rw/article/29618/entertainment/fashion/kigali-fashion-week-set-for-comeback-under-new-management" target="_blank">More Info</a></p>`;
        ...
        <a href="https://ubumuntuartsfestival.com/about-us/" target="_blank">More Info</a></p>`;
        ...
        <a href="https://en.wikipedia.org/wiki/Rwanda_Film_Festival" target="_blank">More Info</a></p>`;
        ...
        Cost: Free<br>
        <a href="https://www.kigaliphotofest.com/" target="_blank">More Info</a></p>`;
        ...
        <a href="https://www.visitrwandagorilla.com/hobe-rwanda-festival/" target="_blank">More Info</a></p>`;
    }
        ...
        <a href="https://egotickets.com/events/umoja-fest-2025" target="_blank">More Info</a></p>`;
        ...
        <a href="https://umuganura.com" target="_blank">More Info</a></p>`;
        ...
        Cost: Free<br>
        <a href="https://en.wikipedia.org/wiki/Liberation_Day_(Rwanda)" target="_blank">More Info</a></p>`;
        ...
        <a href="https://www.allaboutrwanda.com/umuganda.html" target="_blank">More Info</a></p>`;
        ...
        Cost: Free (Respectful Entry)<br>
        <a href="https://genocidearchiverwanda.org.rw/category/Remembrance" target="_blank">More Info</a></p>`;
    }
        ...
        <a href="https://www.ishyoartscentre.org/kigali-up-fesival/" target="_blank">More Info</a></p>`;
        output += `<p><span class="event-title">Kivu Fest</span><br>
        <span class="event-details">Date: July 10, 2026<br>
        Place: Lake Kivu, Rubavu<br>
        Cost: 10,000–30,000 RWF<br>
        <a href="https://kivufest.com" target="_blank">More Info</a></p>`;
        ...
        <a href="https://misozifest.com" target="_blank">More Info</a></p>`;
        ...
        <a href="https://jazzjunction.com" target="_blank">More Info</a></p>`;
        ...
        Cost: 10,000–20,000 RWF<br>
        <a href="https://choplifekigali.com" target="_blank">More Info</a></p>`;
    }
        ...
        <a href="https://www.tourdurwanda.rw/" target="_blank">More Info</a></p>`;
        ...
        Cost: Free (Spectating)<br>
        <a href="https://gorillarallyrwanda.com" target="_blank">More Info</a></p>`;
    }
        ...
        Cost: 200–1,200 $<br>
        <a href="https://www.mwckigali.com/" target="_blank">More Info</a></p>`;
        output += `<p><span class="event-title">Africa Tech Summit</span><br>
        <span class="event-details">Date: Feb 2026<br>
        Place: Kigali<br>
        Cost: 400–600 $<br>
        <a href="https://africatechsummit.com" target="_blank">More Info</a></p>`;
        ...
        Cost: 1,500–2,500 €<br>
        <a href="https://africaceoforum.com" target="_blank">More Info</a></p>`;
        output += `<p><span class="event-title">Inclusive Fintech Forum</span><br>
        <span class="event-details">Date: June 2026<br>
        Place: KCC<br>
        Cost: 300–500 $<br>
        <a href="https://inclusivefintechforum.com" target="_blank">More Info</a></p>`;
        output += `<p><span class="event-title">Aviation Africa Summit</span><br>
        <span class="event-details">Date: Sep 2026<br>
        Place: KCC<br>
        Cost: 500–800 $<br>
        <a href="https://aviationafrica.com" target="_blank">More Info</a></p>`;
    }
        ...
        Place: KCC, Kigali<br>
        Cost: 200–400 $<br>
        <a href="https://biodiversityconf.com" target="_blank">More Info</a></p>`;
        output += `<p><span class="event-title">Smart City Expo Africa</span><br>
        <span class="event-details">Date: Sep 2026<br>
        Place: Kigali<br>
        Cost: 200–450 $<br>
        <a href="https://smartcityexpoafrica.com" target="_blank">More Info</a></p>`;
    }
        ...
        <a href="https://en.wikipedia.org/wiki/Our_Lady_of_Kibeho" target="_blank">More Info</a></p>`;
        output += `<p><span class="event-title">Assumption Day Pilgrimage</span><br>
        <span class="event-details">Date: Aug 15, 2026<br>
        Place: Kibeho<br>
        Cost: Free<br>
        <a href="https://assumptionpilgrimage.com" target="_blank">More Info</a></p>`;
    ...
    // Inject output into the output section
