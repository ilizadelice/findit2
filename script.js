...
function showEvents(choice) {
    ...
    if (choice === "Arts and Culture") {
        ...
        output += eventHTML("Ubumuntu Arts Festival", "July 13–19, 2026", "Kigali Genocide Memorial Site","In english:A cultural festival using theatre, music, and art to promote peace and humanity. Artists from Africa and around the world perform at the Kigali Genocide Memorial. ","Mu kinyarwanda:Umunsi mukuru wumuco ukoresheje ikinamico, umuziki, nubuhanzi mugutezimbere amahoro nubumuntu. Abahanzi baturutse muri Afrika ndetse no kwisi yose baririmbira ku rwibutso rwa Jenoside rwa Kigali.","Free (Donations)", "https://ubumuntuartsfestival.com/about-us/");
