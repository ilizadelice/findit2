...
function showEvents(choice) {
    let output = "";
    const backgrounds = {
        "Arts and Culture": "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT2FbE6PUDb4SJ-4u3YrQMVpgpGHcdtXswWxw&s')",
